...
{
    public abstract class eCommerceProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static eCommerceProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(eCommerceProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<eCommerceProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<eCommerceProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<eCommerceProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<eCommerceProjectDbContext, Task<T>> func)
        {
            T result;
